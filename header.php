  ...
  <head>
    ...
    <title>APS</title>
      ...
      var menu = $('#menuh');
          ...
          // $('.menuh a').css({'color':'#ddd'});
          // $('.sub-menu').css({'background-color':'rgba(32, 32, 32, 0.8)'})
				}
			});
		});
    ...
    <main>
      ...
      <header class="cabecario">
        <div id="menuHeader" class="flex">
          ...
          <nav  class="menuh ">
            <ul class="mtop">
              <li><a href="index.php"><i class="fa fa-"></i>Home</a></li>
          ...
          <form class="busca" action="index.html" method="post">
            ...
            <button type="button" name="button"><i class="fa fa-send"></i></button>
          </form>
        </div>
